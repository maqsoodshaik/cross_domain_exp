...
dataset_ar = load_dataset("common_voice","ar")
dataset_nl = load_dataset("common_voice", "nl")
dataset_pt = load_dataset("common_voice", "pt")
dataset = concatenate_datasets(
        [dataset_ar,dataset_nl,dataset_pt]
    ).rename_column('locale','label')
...
encoded_dataset = dataset.map(preprocess_function, remove_columns=['client_id', 'path', 'audio', 'sentence', 'up_votes', 'down_votes', 'age', 'gender', 'accent','segment'], batched=True)
encoded_dataset
