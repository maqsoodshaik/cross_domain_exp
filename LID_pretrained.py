...
# encoded_dataset_train =encoded_dataset_train.remove_columns(encoded_dataset_train.column_names)
# encoded_dataset_validation =encoded_dataset_validation.remove_columns(encoded_dataset_train.column_names)
# encoded_dataset_train.to(device)
# encoded_dataset_validation.to(device)
trainer = Trainer(
    model,
    args,
...
trainer.save_model( f"/pretrained/{model_name}_{dataset}_bestmodel")
best_model = AutoModelForAudioClassification.from_pretrained(
    f"/pretrained/{model_name}_{dataset}_bestmodel"
)
trainer = Trainer(
    best_model,
    args,
